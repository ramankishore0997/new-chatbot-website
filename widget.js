    ...
    <div id="gp-chat-window">
      <div class="gp-header">
        ...
        <div style="display:flex; align-items:center; gap:6px;">
          <a href="https://wa.me/919999999999?text=Hi%2C%20I%20want%20to%20attach%20this%20Telegram%20live%20chatbot%20on%20my%20website" target="_blank" style="color:#86efac; text-decoration:none; font-size:12px; font-weight:bold; background:rgba(255,255,255,0.15); padding:3px 8px; border-radius:8px;">WhatsApp</a>
      ...
      <div class="gp-body" id="gp-messages">
        ...
        <div id="gp-quick-box" style="display:flex; flex-wrap:wrap; gap:6px; margin-top:4px;">
          <a href="https://wa.me/919999999999?text=Hi%2C%20I%20want%20to%20attach%20this%20Telegram%20live%20chatbot%20on%20my%20website" target="_blank" class="gp-quick-btn" style="background:#ecfdf5; color:#065f46; border-color:#a7f3d0; font-weight:bold;">📱 WhatsApp (9999999999)</a>
      ...
      <div class="gp-footer">
        ...
        <div style="text-align:center; font-size:10px; color:#94a3b8; margin-top:6px;">⚡ Connected via Telegram & WhatsApp (9999999999)</div>
      </div>
    </div>
